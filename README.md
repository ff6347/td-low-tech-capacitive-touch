...
![A paper sheet with copper wire attached and graphite scribbles](docs/capacitive_touch_sensor_low_tech-01.jpeg)

![A room with a messy desk in front and people in the back](docs/capacitive_touch_sensor_low_tech-02.jpeg)

![An Arduino Uno R3 with wires attached to pin 2 5v going to a breadboard some resistor and a paper with copper tape on it](docs/capacitive_touch_sensor_low_tech-03.jpeg)
